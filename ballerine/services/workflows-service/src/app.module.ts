...
import { ZitadelAuthMiddleware } from '@/common/middlewares/zitadel-auth.middleware';
...
export class AppModule {
  configure(consumer: MiddlewareConsumer) {
    // ZitadelAuthMiddleware runs FIRST (before AuthKeyMiddleware) to allow Zitadel tokens
    // If Zitadel auth fails, it falls through to allow API keys, sessions, etc.
    consumer
      .apply(
        RequestIdMiddleware,
