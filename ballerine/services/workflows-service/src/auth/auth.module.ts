...
import { LocalJwtStrategy } from '@/auth/local-jwt/local-jwt.strategy';
import { LocalJwtAuthService } from '@/auth/local-jwt/local-jwt-auth.service';
...
@Module({
  ...
  exports: [AuthService, PasswordService, PassportModule, LocalJwtAuthService],
})
