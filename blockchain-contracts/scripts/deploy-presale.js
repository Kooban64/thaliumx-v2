...
async function main() {
    ...
    // Deploy contract
    const ThaliumPresale = await hardhat_1.ethers.getContractFactory('ThaliumPresale');
    const presale = await ThaliumPresale.deploy(USDT_TESTNET, // usdtTokenAddress
...
//# sourceMappingURL=deploy-presale.js.map