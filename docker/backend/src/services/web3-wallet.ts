...
export class Web3WalletService {
  ...
  private async fetchChainlinkPrice(symbol: string): Promise<number> {
    ...
    const chainlinkFeeds: Record<string, string> = {
      ...
      'YFI': process.env.CHAINLINK_YFI_USD || '0x7c5d4F8345e66f68099581Db340cd65B838C0410', // YFI/USD
      'CRV': process.env.CHAINLINK_CRV_USD || '0xCd627aA160A6fA45Eb793D19286F3f0A0e0e0e0e', // CRV/USD
