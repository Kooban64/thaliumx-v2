/**
 * Enterprise Logger for DEX Compliance Service
...
export interface Logger {
  ...
  // Blockchain logging
  logBlockchain(event: string, chainId: number, details?: Record<string, unknown>): void;
}
...
class WinstonLogger implements Logger {
  ...
  logBlockchain(event: string, chainId: number, details?: Record<string, unknown>): void {
    winstonLogger.info(`Blockchain: ${event}`, {
      event,
      chainId,
      category: 'blockchain',
      ...details,
