...
import { SecurityOversight } from '@/components/admin/security/SecurityOversight';

/**
 * Security Oversight Page
 */
  ...
  useEffect(() => {
    const checkAuthAndRedirect = async () => {
      try {
        ...
        if (!isAuthenticated) {
          router.push('/login?next=/admin/security/oversight');
          return;
        }
