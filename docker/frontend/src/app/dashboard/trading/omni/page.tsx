...
import { OmniTradingInterface } from '@/components/trading/OmniTradingInterface';
import { useTradingStore } from '@/stores/tradingStore';

/**
 * Omni-Exchange Trading Page
 */
export default function OmniTradingPage() {
  const router = useRouter();
  const [isLoading, setIsLoading] = useState(true);
  const { setSelectedExchange } = useTradingStore();

  useEffect(() => {
    setSelectedExchange('omni');
  }, [setSelectedExchange]);
