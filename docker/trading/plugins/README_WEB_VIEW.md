# ThaliumX Plugin Starter

ThaliumX plugin starter is a package with some pre-defined configurations out of the box to create custom plugins for the [ThaliumX kit software](https://github.com/thalium/thaliumx-kit). These plugins can be installed on the fly to add features to your exchange.
...
To decide where to inject remote components, we are using the [smart target](https://github.com/thalium/thaliumx-kit/blob/master/web/src/components/SmartTarget/index.js) component in the kit.
...
You can always check the latest available common props for remote components by checking the [smart target](https://github.com/thalium/thaliumx-kit/blob/master/web/src/components/SmartTarget/index.js) component in codebase.
...
- [New Page](https://github.com/thalium/thaliumx-kit/blob/8e617abf15c503e2e8483ffc5f4ae3e7befa4401/web/src/routes.js#L240)
- Fiat Wallet
    - [Deposit](https://github.com/thalium/thaliumx-kit/blob/8e617abf15c503e2e8483ffc5f4ae3e7befa4401/web/src/containers/Deposit/utils.js#L169)
    - [Withdraw](https://github.com/thalium/thaliumx-kit/blob/8e617abf15c503e2e8483ffc5f4ae3e7befa4401/web/src/containers/Withdraw/form.js#L257)
- New Verification Tab
    - [Home](https://github.com/thalium/thaliumx-kit/blob/8e617abf15c503e2e8483ffc5f4ae3e7befa4401/web/src/containers/Verification/index.js#L234)
    - [Page Content](https://github.com/thalium/thaliumx-kit/blob/8e617abf15c503e2e8483ffc5f4ae3e7befa4401/web/src/containers/Verification/index.js#L256)
- Bank Verification Tab
    - [Home](https://github.com/thalium/thaliumx-kit/blob/8e617abf15c503e2e8483ffc5f4ae3e7befa4401/web/src/containers/Verification/index.js#L355)
    - [Page Content](https://github.com/thalium/thaliumx-kit/blob/8e617abf15c503e2e8483ffc5f4ae3e7befa4401/web/src/containers/Verification/index.js#L506)
- KYC Verification Tab
    - [Home](https://github.com/thalium/thaliumx-kit/blob/8e617abf15c503e2e8483ffc5f4ae3e7befa4401/web/src/containers/Verification/index.js#L380)
    - [Page Content](https://github.com/thalium/thaliumx-kit/blob/8e617abf15c503e2e8483ffc5f4ae3e7befa4401/web/src/containers/Verification/index.js#L523)
