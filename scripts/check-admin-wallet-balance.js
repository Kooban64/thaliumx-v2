 ...
 * 
 * Note: This script uses CommonJS format for compatibility
 */
...
async function checkBalances() {
  try {
    ...
    // Check if contract can mint (for USDT)
    console.log("💡 Note: USDT on testnet may need to be minted or transferred");
    console.log("   Use the top-up script to add funds if needed\n");
